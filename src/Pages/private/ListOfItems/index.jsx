    ...
    <main className={"w-screen h-screen overflow-hiddeb"}>
      ...
      <div className="max-w-[1200px] h-full p-4 rounded-lg m-auto bg-gray-800">
        <div className="flex item-center justify-between">
          <input className={"bg-white"} placeholder="Filtro: "/>
          <Button>Cadastrar Serviço +</Button>
        </div>

       <div className={"w-full flex flex-wrap items-center justify-center mt-20 gap-4"}>
        {data?.map((item) => (
          <div className={"flex rounded-lg bg-blue-950 gap-4 p-4"}>
            <img src="https://placehold.co/200x200" alt={"New Alt"} className="w-[200px] h-[200px] rounded-lg" />
